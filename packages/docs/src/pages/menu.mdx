...
<iframe class="w-full h-[378px] mt-8 mb-4 rounded-xl" src="/svelte-headlessui/example/menu" frameborder="0" scrolling="no"></iframe>
<a href="/svelte-headlessui/example/menu" target="_blank">
