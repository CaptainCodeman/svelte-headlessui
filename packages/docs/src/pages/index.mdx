...
You may be interested in evaluating [@rgossiaux/svelte-headlessui](https://svelte-headlessui.goss.io). This package aligns closer to the official components in it's approach although I believe that approach (driven by React / Vue) contributes to the [larger size of 140.1kB minified / 27.5kB minified + gzipped](https://bundlephobia.com/package/@rgossiaux/svelte-headlessui@2.0.0).
