...
<iframe class="w-full h-[170px] mt-8 mb-4 rounded-xl" src="/svelte-headlessui/example/button" frameborder="0" scrolling="no"></iframe>
<a href="/svelte-headlessui/example/button" target="_blank">
